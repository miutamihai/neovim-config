...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = require 'custom.setup.lsp.on_attach',
      })
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = require 'custom.setup.treesitter.languages',
      auto_install = false,
      highlight = {
        enable = true,
...
local setup_user_commands = require 'custom.setup.user_commands'
